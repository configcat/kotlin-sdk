...
object DarwinComparatorsTests : TestSet {
  ...
  - IF User.Number > '0.9' => true
    ...
    THEN '11' => no match
  - IF User.Date BEFORE '1693497600' (2023-08-31T16:00:00Z UTC) => true
    AND User.Date AFTER '1693497600' (2023-08-31T16:00:00Z UTC) => false, skipping the remaining AND conditions
    THEN '12' => no match
